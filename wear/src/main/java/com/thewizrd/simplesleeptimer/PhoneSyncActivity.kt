...
import com.thewizrd.simplesleeptimer.databinding.ActivitySetupSyncBinding
                ...
                if (ACTION_UPDATECONNECTIONSTATUS == intent.action) {
                    when (WearConnectionStatus.valueOf(
                        ...
                        WearConnectionStatus.DISCONNECTED -> {
                            ...
                            binding.circularProgress.setOnClickListener(null)
                            stopProgressBar()
                        }
                        ...
                        WearConnectionStatus.CONNECTED -> {
                            ...
                            // Continue operation
                            startActivity(
                                Intent(this@PhoneSyncActivity, SleepTimerActivity::class.java)
