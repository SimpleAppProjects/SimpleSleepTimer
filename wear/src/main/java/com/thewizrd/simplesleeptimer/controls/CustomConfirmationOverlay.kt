 ...
 * branch: pie-release
 */
package com.thewizrd.simplesleeptimer.controls
...
import com.thewizrd.simplesleeptimer.utils.ResourcesUtils
import java.util.*
    ...
    private fun updateOverlayView(context: Context) {
        if (mOverlayView == null) {
            mOverlayView = LayoutInflater.from(context).inflate(
                if (mType == CUSTOM_ANIMATION) R.layout.ws_customoverlay_confirmation else R.layout.ws_overlay_confirmation,
                null
            )
        }
